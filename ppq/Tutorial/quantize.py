...
ONNX_PATH        = '/home/haoyu/work/code/ppq/my_test/onnx_example/ResNet-50/resnet50.onnx'
...
# ------------------------------------------------------------
# 将前十个误差最大的层送上FP32，并重新量化
# ------------------------------------------------------------
for op_name, _ in sensitivity[: 10]:
    QSetting.dispatching_table.append(operation=op_name, platform=TargetPlatform.FP32)
