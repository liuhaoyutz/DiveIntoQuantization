...
resnet50.eval()  
filename = 'dog.jpg' # change to your filename
...
ort_output = run_sample(session_fp32, 'dog.jpg', categories, input_batch)
print("ONNX Runtime CUDA Inference time = {} ms".format(format(sum(latency) * 1000 / len(latency), '.2f')))
