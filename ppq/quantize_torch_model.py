...
quantized = quantize_torch_model(
    ...
    onnx_export_file='Output/resnet18.onnx', device=DEVICE, verbose=0)
...
export_ppq_graph(graph=quantized, platform=PLATFORM,
                 graph_save_to='Output/resnet18_quantized(onnx).onnx',
                 config_save_to='Output/resnet18_quantized(onnx).json')
